...
CARPETA   = "nucleo"
RUTA_HTML = os.path.join(CARPETA, "Monitor_Nucleo.html")
...
# JSON: nucleo/hitos_nucleo.json  —  misma estructura que Golar
# =============================================================================
RUTA_HITOS = os.path.join(CARPETA, "hitos_nucleo.json")
...
def monitor_nucleo_v1():
    try:
        ...
        print("[nucleo] Descargando datos...")
        ...
        print("[nucleo] Generando gráfico...")
    ...
    <table class='table table-dark mb-0' style='font-size:0.82rem;'>
      ...
      <tbody>
        ...
        with open(RUTA_HTML, "w", encoding="utf-8") as f:
            f.write(html)
        print(f"[nucleo] HTML guardado en {RUTA_HTML}")
        ...
        # ── Telegram ──
        if ENVIAR_TELEGRAM:
            print("[nucleo] Enviando a Telegram...")
            ...
            print("[nucleo] Enviado a Telegram.")
